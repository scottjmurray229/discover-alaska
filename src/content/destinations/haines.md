...
budgetPerDay:
  ...
  midRange: 250
  luxury: 500
gettingThere: "Reach Haines by Alaska Marine Highway ferry from Juneau (4.5 hours), fly from Juneau on Alaska Seaplanes (35 minutes), or drive the Haines Highway from the Alaska Highway in Yukon."
essentials:
  - icon: "🦅"
    label: "Eagle Preserve"
    value: "48,000 acres"
  - icon: "🎨"
    label: "Arts Scene"
    value: "20+ galleries"
  ...
  - icon: "🎭"
    label: "Events"
    value: "Southeast Alaska State Fair"
highlights:
  - title: "Alaska Chilkat Bald Eagle Preserve"
    icon: "🦅"
    image: ""
  - title: "Chilkat Valley Arts Scene"
    icon: "🎨"
    image: ""
  - title: "Rainbow & Davidson Glaciers"
    icon: "🏔️"
    image: ""
  - title: "Haines Highway Scenic Drive"
    icon: "🚗"
    image: ""
  - title: "Fort William H. Seward"
    icon: "🏛️"
    image: ""
  - title: "Lutak Inlet Kayaking"
    icon: "🛶"
    image: ""
gradientColors: "from-emerald-700 via-sky-500 to-slate-300"
relatedDestinations: [juneau, skagway, glacier-bay]
...
**Explore Fort William H. Seward**, the beautifully restored former military post on the south end of town. Wander among the officers' quarters (now B&Bs and residences), visit the Alaska Indian Arts center to watch master Tlingit carvers at work (free admission, donations welcome), and check the schedule at the Chilkat Center for the Arts for performances and events.
...
**Mid-Range:** **Hotel Halsingland** at Fort Seward is a charming historic hotel with rooms in the restored officers' quarters. Rates run $160 to $250 per night, and the location amid the fort's grounds is unbeatable. **Captain's Choice Motel** downtown offers reliable, comfortable rooms from $170 to $230 with mountain views.
...
**Mountain Market & Cafe** is the town's natural foods store and cafe, perfect for coffee, sandwiches, smoothies, and baked goods. It doubles as a community hub where you can pick up local event information. Items $5 to $14.
