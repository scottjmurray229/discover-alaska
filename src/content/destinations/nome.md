...
budgetPerDay:
  ...
  midRange: 275
  luxury: 500
gettingThere: "Fly from Anchorage to Nome on Alaska Airlines (about 1.5 hours), as there are no roads connecting Nome to the rest of the state."
essentials:
  - icon: "🏁"
    label: "Iditarod Finish"
    value: "Mid-March annually"
  - icon: "🪙"
    label: "Gold Rush"
    value: "Est. 1898"
  - icon: "🦅"
  ...
  - icon: "🌡️"
    ...
    value: "50-60°F"
highlights:
  - title: "Iditarod Finish Line"
    icon: "🏁"
    image: ""
  - title: "Gold Panning on the Beach"
    icon: "🪙"
    image: ""
  - title: "Birding the Seward Peninsula"
    icon: "🦅"
    image: ""
  - title: "Council Road Drive"
    icon: "🚗"
    image: ""
  - title: "Bering Land Bridge Preserve"
    icon: "🏔️"
    image: ""
  - title: "Pilgrim Hot Springs"
    icon: "♨️"
    image: ""
gradientColors: "from-slate-600 via-amber-500 to-blue-700"
relatedDestinations: [utqiagvik, fairbanks, anchorage]
