...
budgetPerDay:
  ...
  midRange: 225
  luxury: 550
gettingThere: "Drive 2.5 hours north of Anchorage on the Parks Highway (mile 98.7), or take the Alaska Railroad from Anchorage or Denali National Park."
essentials:
  - icon: "🏔️"
    label: "Denali Views"
    value: "Clear days only (~30%)"
  - icon: "✈️"
    label: "Flightseeing"
    value: "Glacier landings available"
  - icon: "🧗"
    label: "Climbing Base"
    value: "For Denali expeditions"
  - icon: "🎉"
    label: "Quirk Factor"
    value: "Cat mayor (honorary)"
  - icon: "🚂"
    label: "Railroad Stop"
    value: "Alaska Railroad flag stop"
  - icon: "🌲"
    label: "Population"
    value: "~1,100"
highlights:
  ...
  - title: "Historic Main Street"
    icon: "🏘️"
    image: ""
  - title: "Susitna River Rafting"
    icon: "🛶"
    image: ""
  - title: "Talkeetna Ranger Station"
    icon: "🏔️"
    image: ""
  - title: "Craft Breweries & Distilleries"
    icon: "🍺"
    image: ""
  - title: "Winterfest & Moose Dropping Festival"
    icon: "🎉"
    image: ""
gradientColors: "from-sky-400 via-white to-green-700"
relatedDestinations: [denali-national-park, anchorage, fairbanks]
...
**River Rafting on the Susitna and Talkeetna Rivers** offers everything from gentle scenic floats to class III whitewater. Denali Southside River Guides and Talkeetna River Guides run half-day trips ($95 to $130 per person) and full-day adventures ($195 to $250) that combine rapids with wildlife viewing. The Talkeetna River float is family-friendly, while the Devil's Canyon stretch of the Susitna delivers serious whitewater.

**Walk Historic Main Street** and browse the galleries, shops, and historic buildings that line this three-block stretch of quintessential Alaska character. Stop at the Talkeetna Historical Society Museum ($5 admission) housed in a collection of original railroad-era buildings. The museum's scale model of Denali is remarkably detailed and helps you understand the mountain's geography.
...
**Wildflower Cafe** is the town's best dinner option, with creative seasonal menus featuring local fish, Alaska-raised meats, and garden produce. The halibut entrees and handmade pasta are standouts. Dinner entrees $20 to $38. Reservations strongly recommended.
