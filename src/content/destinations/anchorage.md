...
budgetPerDay:
  ...
  midRange: 225
  luxury: 550
gettingThere: "Ted Stevens Anchorage International Airport (ANC) receives direct flights from Seattle, Minneapolis, Denver, Chicago, and other major US cities year-round."
essentials:
  - icon: "🌡️"
    label: "Summer Highs"
    value: "60-70°F (Jun-Aug)"
  - icon: "👥"
    label: "Population"
    value: "291,000"
  - icon: "🕐"
    label: "Time Zone"
    value: "Alaska (AKST, UTC-9)"
  - icon: "🏔️"
    label: "Elevation"
    value: "102 ft"
  - icon: "☀️"
    label: "Summer Daylight"
    value: "19+ hours in June"
  - icon: "🐻"
    label: "Urban Moose"
    value: "~1,500 in city limits"
highlights:
  ...
  - title: "Earthquake Park"
    icon: "🌍"
    image: ""
  - title: "Ship Creek Salmon Viewing"
    icon: "🐟"
    image: ""
gradientColors: "from-sky-600 via-emerald-500 to-slate-700"
relatedDestinations: [kenai-fjords, denali-national-park, seward]
...
**Alaska Wildlife Conservation Center** — Located 50 miles south on the Seward Highway, this refuge houses bears, moose, bison, musk oxen, and other animals that cannot survive in the wild. Admission is $15 for adults, $10 for children. Worth the drive, especially combined with the stunning Turnagain Arm scenery along the way.

**Flattop Mountain Hike** — The trailhead is a 20-minute drive from downtown in Chugach State Park. The 1.5-mile trail gains 1,350 feet and rewards with 360-degree views. Parking requires an Alaska State Parks pass ($5 daily). Free in winter, though crampons are essential.

**Anchorage Museum** — The state's finest museum covers Alaska Native cultures, Arctic science, and contemporary art. The Smithsonian Arctic Studies Center houses 600 Alaska Native artifacts. Admission is $20 for adults. Allow at least 2-3 hours.

**Ship Creek Salmon Viewing** — From June through September, king and silver salmon run up Ship Creek right in downtown Anchorage. You can fish here with a one-day non-resident license ($25) or simply watch from the viewing platform.

**Flightseeing** — Several operators at Lake Hood, the world's busiest floatplane base, offer scenic flights over glaciers, Denali, and Prince William Sound. Expect $200-350 per person for a 60-90 minute flight. Rust's Flying Service and Regal Air are well-established operators.
...
**Mid-Range ($180-280/night)** — The Lakefront Anchorage (formerly the Millennium) sits on the shore of Lake Spenard near the floatplane base and offers solid rooms with mountain views. The Anchorage Grand Hotel downtown provides apartment-style suites with kitchens, ideal for families.
...
**Snow City Cafe** — The go-to breakfast spot downtown. Lines form early on weekends for dishes like king crab eggs Benedict and reindeer sausage scrambles. Entrees $14-22.

**Simon & Seafort's** — An Anchorage classic perched above Cook Inlet with sweeping views of the Alaska Range. Known for seafood and steaks. Dinner entrees $30-55. Reservations recommended.

**Spenard Roadhouse** — A beloved neighborhood restaurant in the funky Spenard district. Brunch is outstanding, and the rotating seasonal menu leans on local ingredients. Entrees $18-35.
