...
budgetPerDay:
  ...
  midRange: 275
  luxury: 550
gettingThere: "Drive 305 miles from Anchorage via the Glenn and Richardson Highways (5.5 hours), or fly from Anchorage on Ravn Alaska."
essentials:
  - icon: "🏔️"
    label: "Nickname"
  ...
  - icon: "👥"
    label: "Population"
    value: "~3,900 residents"
  - icon: "🌡️"
    label: "Summer Temps"
    value: "50-65°F (10-18°C)"
  - icon: "🛢️"
    label: "Oil Pipeline"
    value: "Trans-Alaska Pipeline terminus"
  - icon: "❄️"
    label: "Snowfall"
    value: "Average 300+ inches per year"
  - icon: "🧊"
    label: "Glacier"
    value: "Columbia Glacier (nearby)"
highlights:
  - title: "Columbia Glacier Cruise"
    icon: "🧊"
    image: ""
  - title: "Thompson Pass & Worthington Glacier"
    icon: "🏔️"
    image: ""
  - title: "Prince William Sound Kayaking"
    icon: "🛶"
    image: ""
  - title: "Valdez Museum"
    icon: "🏛️"
    image: ""
  - title: "Keystone Canyon Waterfalls"
    icon: "💧"
    image: ""
  - title: "Heli-Skiing & Extreme Skiing"
    icon: "⛷️"
    image: ""
gradientColors: "from-slate-700 via-blue-600 to-cyan-500"
relatedDestinations: [whittier, anchorage, wrangell-st-elias]
