...
heroVideo: ""
heroImage: ""
tagline: "Where Cultures and Tides Converge"
region: southeast
...
budgetPerDay:
  ...
  midRange: 250
  luxury: 575
gettingThere: "Fly from Juneau, Anchorage, or Seattle to Sitka Rocky Gutierrez Airport (SIT), or arrive by Alaska Marine Highway ferry from Juneau or other Southeast Alaska ports."
essentials:
  - icon: "👥"
    label: "Population"
    value: "8,500"
  - icon: "🏛️"
    label: "Russian Heritage"
    value: "Capital of Russian America until 1867"
  - icon: "🌧️"
    label: "Annual Rainfall"
    value: "86 inches"
  - icon: "🐋"
    label: "Whale Season"
    value: "Year-round (peak Jun-Sep)"
  - icon: "🌲"
    label: "Rainforest"
    value: "Tongass National Forest"
  - icon: "🪶"
    label: "Indigenous Culture"
    value: "Tlingit homeland"
highlights:
  ...
  - title: "Alaska Raptor Center"
    icon: "🦅"
    image: ""
  - title: "Mount Verstovia Trail"
    icon: "🥾"
    image: ""
gradientColors: "from-emerald-800 via-teal-500 to-slate-500"
relatedDestinations: [juneau, glacier-bay, ketchikan]
