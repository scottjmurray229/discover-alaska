...
budgetPerDay:
  ...
  midRange: 300
  luxury: 550
gettingThere: "Fly from Anchorage or Fairbanks to Utqiagvik on Alaska Airlines (about 2.5 hours from Anchorage)."
essentials:
  - icon: "🌍"
    label: "Latitude"
    value: "71.29°N"
  ...
  - icon: "🌑"
    ...
    value: "Nov 18 - Jan 23"
  - icon: "🐋"
    label: "Whaling Culture"
    value: "Spring & Fall hunts"
  - icon: "🌡️"
    label: "July Average"
    value: "40-47°F"
  - icon: "👥"
    ...
    value: "~4,500"
highlights:
  - title: "Whale Bone Arch"
    icon: "🐋"
    image: ""
  - title: "Midnight Sun Festival"
    icon: "☀️"
    image: ""
  - title: "Inupiat Heritage Center"
    icon: "🏛️"
    image: ""
  - title: "Point Barrow - Nuvuk"
    icon: "📍"
    image: ""
  - title: "Arctic Ocean Shore"
    icon: "🌊"
    image: ""
  - title: "Northern Lights Viewing"
    icon: "🌌"
    image: ""
gradientColors: "from-indigo-900 via-blue-400 to-white"
relatedDestinations: [nome, fairbanks, anchorage]
...
affiliatePicks:
  ...
  - name: "Extreme Cold Weather Gear"
    ...
    affiliateUrl: "https://www.amazon.com/s?k=extreme+cold+weather+clothing+arctic&tag=discoverphili-20"
faqItems:
  - question: "Is Utqiagvik worth visiting?"
...
scottTips:
  logistics: "Alaska Airlines flies daily from Anchorage to Utqiagvik (BRW) — about 1.5 hours, $400-800+ round trip. No road connection exists. Book flights and the one main hotel well in advance."
...
Utqiagvik is America's northernmost city — 330 miles above the Arctic Circle on the Arctic Ocean coast, with Inupiaq culture, polar bear viewing, and 82 days of midnight sun, budget $150-300/day, accessible only by air.

<div class="immersive-break-inline">
  <video autoplay muted loop playsinline preload="metadata">
    <source src="/videos/destinations/utqiagvik-hero.mp4" type="video/mp4" />
  </video>
  <div class="ib-gradient" style="background: linear-gradient(135deg, #0c4a6e, #e2e8f0, #1e3a5f);"></div>
  <div class="ib-content">
    <div class="ib-title">Top of the World</div>
    <p class="ib-text">Utqiagvik sits at 71 degrees north — the sun does not set for 82 days each summer, and polar bears roam the frozen sea just outside town.</p>
  </div>
</div>
...
**Visit the Inupiat Heritage Center**, a Smithsonian-affiliated museum and cultural center that is the best place to begin understanding Utqiagvik. Exhibits cover traditional and contemporary Inupiat life, from whaling technology to ivory carving to the impacts of climate change on Arctic communities. Artists and elders often demonstrate traditional crafts in the center's workshop space. Admission is around $10.
...
**Sam & Lee's Chinese Restaurant** offers Chinese-American food in generous portions. It is a local favorite for takeout and dine-in, with combination plates running $16 to $28.
