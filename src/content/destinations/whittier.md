...
budgetPerDay:
  ...
  midRange: 275
  luxury: 600
gettingThere: "Drive 60 miles southeast of Anchorage through the Anton Anderson Memorial Tunnel, the longest highway tunnel in North America (2.5 miles), which operates on a scheduled alternating traffic pattern."
essentials:
  - icon: "🚇"
    label: "Tunnel Access"
    value: "One-way, scheduled times"
  - icon: "🏢"
    label: "Begich Towers"
    value: "~200 residents, 1 building"
  - icon: "🧊"
    label: "Glaciers"
    value: "26 named glaciers nearby"
  - icon: "🐋"
    label: "Wildlife"
    value: "Whales, otters, seals"
  - icon: "🌧️"
    label: "Rainfall"
    value: "~200 inches/year"
  - icon: "⛴️"
    label: "Ferry Hub"
    value: "Alaska Marine Highway"
highlights:
  - title: "Prince William Sound Cruises"
    icon: "⛴️"
    image: ""
  - title: "Blackstone Bay Glaciers"
    icon: "🧊"
    image: ""
  - title: "Sea Kayaking Adventures"
    icon: "🛶"
    image: ""
  - title: "Begich Towers Community"
    icon: "🏢"
    image: ""
  - title: "Portage Pass Trail"
    icon: "🥾"
    image: ""
  - title: "Alaska Marine Highway"
    icon: "⛴️"
    image: ""
gradientColors: "from-slate-500 via-cyan-600 to-blue-900"
relatedDestinations: [anchorage, seward, valdez]
...
**Mid-Range:** **Inn at Whittier** is the town's primary hotel, offering comfortable waterfront rooms with views over the harbor and Prince William Sound. Rooms run $189 to $289 per night during summer. The hotel has a restaurant and is within walking distance of all tour operators. **June's Whittier Condo Suites** in Begich Towers offers an authentic local experience: you stay in the very building where nearly the entire town lives. Rates start around $150 for a basic unit.
...
**China Sea** in Begich Towers provides Chinese-American fare to the town's residents and visitors alike. Eating here offers the unique experience of dining inside the building where the entire community lives. Combination plates $14 to $22.
