...
budgetPerDay:
  ...
  midRange: 280
  luxury: 575
gettingThere: "Drive 225 miles from Anchorage via the Sterling Highway (4.5 hours), fly from Anchorage on Ravn Alaska, or take the Alaska Marine Highway ferry."
essentials:
  - icon: "🐟"
    label: "Famous For"
    value: "Halibut Fishing Capital of the World"
  - icon: "👥"
    label: "Population"
    value: "~5,800 residents"
  - icon: "🌡️"
    label: "Summer Temps"
    value: "52-62°F (11-17°C)"
  - icon: "🎨"
    label: "Art Scene"
    value: "Galleries, studios, and arts festivals"
  - icon: "🐻"
    label: "Bear Viewing"
    value: "Across Kachemak Bay & Katmai access"
  - icon: "🏖️"
    label: "Homer Spit"
    value: "4.5-mile natural gravel bar"
highlights:
  - title: "Homer Spit"
    icon: "🏖️"
    image: ""
  - title: "Halibut Fishing Charters"
    icon: "🎣"
    image: ""
  - title: "Kachemak Bay State Park"
    icon: "🏞️"
    image: ""
  - title: "Bear Viewing Flights"
    icon: "🐻"
    image: ""
  - title: "Art Galleries & Studios"
    icon: "🎨"
    image: ""
  - title: "Islands and Ocean Visitor Center"
    icon: "🦅"
    image: ""
gradientColors: "from-sky-600 via-amber-500 to-emerald-700"
relatedDestinations: [seward, kenai-fjords, kodiak]
...
scottTips:
  logistics: "Drive from Anchorage — 220 miles, 4-5 hours down the Sterling Highway through the Kenai Peninsula. The drive itself is scenic and worth stopping along the way. Alaska Airlines and small carriers serve Homer Airport seasonally."
...
<div class="immersive-break-inline">
  <video autoplay muted loop playsinline preload="metadata">
    <source src="/videos/destinations/homer-hero.mp4" type="video/mp4" />
  </video>
  <div class="ib-gradient" style="background: linear-gradient(135deg, #0c4a6e, #065f46, #92400e);"></div>
  <div class="ib-content">
    <div class="ib-title">End of the Road</div>
    <p class="ib-text">The 4.5-mile Homer Spit juts into Kachemak Bay with fishing charters, galleries, and one of Alaska's most iconic small-town waterfronts.</p>
  </div>
</div>
