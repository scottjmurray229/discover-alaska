...
budgetPerDay:
  ...
  midRange: 300
  luxury: 650
gettingThere: "Fly from Anchorage to Kodiak on Alaska Airlines or Ravn Alaska (1 hour), or take the Alaska Marine Highway ferry from Homer (10 hours)."
essentials:
  - icon: "🐻"
    label: "Famous For"
    value: "Kodiak brown bears (largest land predator)"
  - icon: "👥"
    label: "Population"
    value: "~6,100 in town, ~13,500 island"
  - icon: "🌡️"
    label: "Summer Temps"
    value: "50-65°F (10-18°C)"
  - icon: "⚓"
    label: "Fishing Fleet"
    value: "Largest in Alaska by value"
  - icon: "🏝️"
    label: "Island Size"
    value: "2nd largest island in the US"
  - icon: "🛡️"
    label: "Coast Guard"
    value: "Largest USCG base in the US"
highlights:
  - title: "Kodiak Brown Bear Viewing"
    icon: "🐻"
    image: ""
  - title: "Kodiak National Wildlife Refuge"
    icon: "🌿"
    image: ""
  - title: "Commercial Fishing Heritage"
    icon: "⚓"
    image: ""
  - title: "Fort Abercrombie State Park"
    icon: "🏰"
    image: ""
  - title: "Baranov Museum"
    icon: "🏛️"
    image: ""
  - title: "Emerald Island Hiking"
    icon: "🥾"
    image: ""
gradientColors: "from-green-800 via-emerald-600 to-blue-700"
relatedDestinations: [homer, katmai-national-park, anchorage]
