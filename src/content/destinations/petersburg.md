...
budgetPerDay:
  ...
  midRange: 225
  luxury: 450
gettingThere: "Fly from Juneau or Sitka on Alaska Airlines (30 minutes), or take the Alaska Marine Highway ferry from Juneau (8 hours) or Wrangell (3 hours)."
essentials:
  - icon: "🇳🇴"
    label: "Heritage"
    value: "Norwegian founded, 1897"
  - icon: "🧊"
    label: "LeConte Glacier"
    value: "Southernmost tidewater"
  - icon: "🦐"
    label: "Fishing Fleet"
    value: "Largest in SE Alaska"
  - icon: "🚢"
    label: "Cruise Ships"
    value: "Too small for large ships"
  - icon: "🐋"
    label: "Whale Watching"
    value: "Humpbacks in Frederick Sound"
  - icon: "🎨"
    label: "Rosemaling"
    value: "Norwegian folk art tradition"
highlights:
  - title: "LeConte Glacier"
    icon: "🧊"
    image: ""
  - title: "Frederick Sound Whale Watching"
    icon: "🐋"
    image: ""
  - title: "Norwegian Heritage Downtown"
    icon: "🇳🇴"
    image: ""
  - title: "Stikine River Delta"
    icon: "🦅"
    image: ""
  - title: "Petroglyph Beach"
    icon: "🪨"
    image: ""
  - title: "Tongass National Forest Trails"
    icon: "🌲"
    image: ""
gradientColors: "from-blue-600 via-emerald-500 to-slate-400"
relatedDestinations: [juneau, sitka, wrangell-st-elias]
...
Petersburg's authenticity is not a marketing strategy; it is a consequence of infrastructure. The town's harbor and channel are too shallow and narrow to accommodate large cruise ships, which means the tidal wave of tourism that has transformed other Southeast Alaska communities simply cannot reach here. Small expedition ships and pocket cruisers visit occasionally, but on any given summer day, the ratio of residents to visitors remains solidly in the residents' favor.
...
**Mid-Range:** **Scandia House** is Petersburg's main downtown hotel, offering comfortable rooms within walking distance of everything. Rates run $140 to $220 per night. The hotel's central location and helpful front desk staff make it the natural choice for most visitors. Several B&Bs in the $150 to $250 range provide more personal experiences with local hosts.
...
**Papa Bear's Pizza** is the go-to casual dinner spot, serving pizzas, calzones, and pasta in a family-friendly setting. The seafood pizza with local shrimp is a local favorite. Pizzas $16 to $28.
