...
budgetPerDay:
  ...
  midRange: 300
  luxury: 750
gettingThere: "Fly from Juneau to Gustavus (30 minutes) on Alaska Airlines or take a catamaran day boat; most cruise ships include Glacier Bay as a one-day sailing."
essentials:
  - icon: "🧊"
    label: "Tidewater Glaciers"
    value: "7 active"
  - icon: "📐"
    label: "Park Size"
    value: "3.3 million acres"
  - icon: "🐋"
    label: "Humpback Whales"
    value: "Peak Jul-Aug"
  - icon: "🚢"
    label: "Cruise Ships Allowed"
    value: "2 per day max"
  - icon: "🌊"
    label: "Shoreline"
    value: "1,200+ miles"
  - icon: "🛶"
    label: "Best For"
    value: "Kayaking & boat tours"
highlights:
  - title: "Margerie Glacier Calving"
    icon: "🧊"
    image: ""
  ...
  - title: "Johns Hopkins Glacier"
    icon: "❄️"
    image: ""
  - title: "Bartlett Cove Rainforest"
    icon: "🌲"
    image: ""
  - title: "Tlingit Cultural Heritage"
    icon: "🪶"
    image: ""
gradientColors: "from-cyan-800 via-blue-300 to-white"
relatedDestinations: [juneau, sitka, haines]
...
**Mid-Range ($220-350/night)** — The Glacier Bay Lodge at Bartlett Cove is the only accommodation inside the park. Rooms are comfortable and the setting — surrounded by rainforest at the edge of the bay — is magnificent. The lodge restaurant serves decent food with bay views. Book very early for summer dates. Annie Mae Lodge in Gustavus offers warm hospitality and home-cooked meals.
...
**The Gustavus Inn** — A renowned small inn that serves communal dinners featuring whatever was caught, picked, or grown that day. The multi-course set dinner ($50-60 per person) is a culinary highlight of Gustavus. Reservations required and often booked weeks ahead.

**Sal's Kitchen** — Casual dining in Gustavus with surprisingly good Mexican-inspired food, fresh fish tacos, and daily specials. Meals $14-22. A welcome change of pace from standard Alaska fare.
