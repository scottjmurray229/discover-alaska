...
budgetPerDay:
  ...
  midRange: 300
  luxury: 600
gettingThere: "Drive the stunning 127-mile Seward Highway from Anchorage (2.5 hours), ride the Alaska Railroad, or arrive by cruise ship or ferry."
essentials:
  - icon: "🏔️"
    label: "Gateway To"
    value: "Kenai Fjords National Park"
  - icon: "👥"
    label: "Population"
    value: "~2,800 residents"
  - icon: "🌡️"
    label: "Summer Temps"
    value: "52-65°F (11-18°C)"
  - icon: "🐋"
    label: "Wildlife"
    value: "Whales, puffins, sea otters, seals"
  - icon: "🏃"
    label: "Famous Event"
    value: "Mount Marathon Race (July 4th)"
  - icon: "🧊"
    label: "Nearby Glacier"
    value: "Exit Glacier (13 miles from town)"
highlights:
  - title: "Kenai Fjords Boat Tours"
    icon: "🚢"
    image: ""
  - title: "Exit Glacier"
    icon: "🧊"
  ...
  - title: "Alaska SeaLife Center"
    icon: "🦭"
    image: ""
  - title: "Seward Highway Scenic Drive"
    icon: "🛣️"
    image: ""
  - title: "Silver Salmon Fishing"
    icon: "🎣"
    image: ""
  - title: "Resurrection Bay Kayaking"
    icon: "🛶"
    image: ""
gradientColors: "from-blue-800 via-cyan-600 to-slate-600"
relatedDestinations: [kenai-fjords, homer, anchorage]
