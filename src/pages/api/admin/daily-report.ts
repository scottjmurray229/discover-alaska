...
export async function GET(context: APIContext): Promise<Response> {
  ...
  try {
    ...
    const subject = `DJ Daily: ${calls} calls, ${fmtCost(cost)}, ${users} users`;
    ...
    const S = {
      ...
      kpiHighlight: 'background:linear-gradient(135deg,rgba(13,115,119,0.15),rgba(9,84,86,0.1));border:1px solid #0077B6;border-radius:8px;padding:12px 14px;',
...
<div style="max-width:640px;margin:24px auto;background:#161b22;border:1px solid #30363d;border-radius:12px;overflow:hidden;">
  <div style="background:linear-gradient(135deg,#0077B6,#005A8C);padding:20px 24px;">
    <div style="font-size:18px;font-weight:700;color:#fff;">Daily Report</div>
    <div style="font-size:12px;color:rgba(255,255,255,0.7);margin-top:2px;">Discover Alaska &middot; Last 24 Hours</div>
  </div>
  ...
  <div style="padding:12px 24px;text-align:center;font-size:11px;color:#484f58;border-top:1px solid #21262d;">
    Claude Haiku 4.5 &middot; <a href="https://discoveralaska.info/api/admin/stats?key=${key}" style="color:#0077B6;text-decoration:none;">Full Dashboard</a>
  </div>
</div>
</body></html>`;
