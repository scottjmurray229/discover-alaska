...
<title>AI Usage Dashboard — Discover Alaska</title>
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .header { background: linear-gradient(135deg, #0077B6, #095456); padding: 24px 32px; display: flex; align-items: center; justify-content: space-between; }
  ...
  .card.highlight { border-color: #0077B6; background: linear-gradient(135deg, rgba(13,115,119,0.15), rgba(9,84,86,0.1)); }
  ...
  .bar { height: 8px; border-radius: 4px; background: #0077B6; min-width: 2px; }
...
<div class="header">
  <div>
    ...
    <div class="meta">Discover Alaska &middot; Claude Haiku 4.5</div>
  </div>
...
<div class="container">
  ...
  <div style="text-align:center; padding: 24px; color: #484f58; font-size: 12px;">
    Claude Haiku 4.5 &middot; Input $0.80/M &middot; Output $4.00/M &middot; <a href="javascript:void(0)" onclick="var u=new URL(window.location.href);u.searchParams.set('format','json');window.location.href=u.toString();" style="color:#0077B6">JSON</a>
  </div>
